...
public class UserCouponController {
	...
	public ResponseEntity<CommonApiResponse<List<GetMyCouponResponse>>> getMyCoupons(@PathVariable Long userId){
		List<GetMyCouponResponse> data = userCouponService.getMyCoupon(userId);
