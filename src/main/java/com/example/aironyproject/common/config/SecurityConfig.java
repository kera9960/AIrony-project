    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/index.html", "/accommodations", "/search", "/detail", "/checkout", "/complete", "/coupons", "/my-coupons", "/likes", "/reservations", "/reservation-detail", "/my-inquiries", "/inquiries", "/admin", "/auth", "/my", "/*.html", "/api/auth/signup", "/api/auth/login", "/api/accommodations/**", "/api/coupons", "/ws/**").permitAll()
